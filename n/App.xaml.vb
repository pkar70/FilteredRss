...
#End Region
    ...
    Protected Overrides Async Sub OnBackgroundActivated(args As BackgroundActivatedEventArgs)
        ...
        Dim bNoComplete As Boolean = RemSysInit(args, sLocalCmds)
...
#Region "Toasty"
    ...
    Public Shared Sub MakeToast(sGuid As String, sMsg As String, sFeed As String)
        ...
        Try
            ...
            If sGuid <> "" Then
                oBldr.AddButton(GetResManString("resDelete"),
                        Microsoft.Toolkit.Uwp.Notifications.ToastActivationType.Background, "DELE" & sGuid)
            End If

            oBldr.AddButton(GetResManString("resOpen"),
...
#Region "Killfile"
    ...
    Public Shared Sub KillFileLoad()
        vb14.DumpCurrMethod()
        VBlib.App.KillFileLoad(Windows.Storage.ApplicationData.Current.LocalCacheFolder.Path)
    End Sub
#End Region
